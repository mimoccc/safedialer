...
class MailClient(
    ...
    val portImap: Int = 993, // 143, 993
    val portSmtp: Int = 465, // 25, 465, 587
    ...
    suspend fun sendMail(
        ...
        val properties = Properties().apply {
            ...
            // Enforce modern TLS and hostname verification for relay
            setProperty("mail.smtp.ssl.protocols", "TLSv1.3 TLSv1.2")
            setProperty("mail.smtp.ssl.checkserveridentity", "true")
            // Do NOT blindly trust all; use default truststore
            remove("mail.smtp.ssl.trust")
        }
        val session = Session.getInstance(properties, object : Authenticator() {
            override fun getPasswordAuthentication(): PasswordAuthentication {
                return PasswordAuthentication(userSmtp, passwordSmtp)
            }
        })
    ...
    suspend fun checkMailCount(
        ...
        val properties = Properties().apply {
            ...
            setProperty("mail.imap.ssl.trust", "*") // Trust all certificates (for self-signed)
            setProperty(
